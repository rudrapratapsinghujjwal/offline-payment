document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("scanQR").addEventListener("click", () => {
        alert("QR Code scanning needs an actual camera scanner.");
    });
    ...
    document.getElementById("listenSound").addEventListener("click", () => {
        alert("Listening for sound payments is not implemented yet.");
    });
    ...
    function playSound(amount) {
        ...
        oscillator.frequency.setValueAtTime(200 + parseInt(amount) * 10, context.currentTime);
